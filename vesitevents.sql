...
CREATE TABLE `feedback_table` (
  ...
  `event_id` int(11) NOT NULL,
  `feeback_form_link` varchar(1000) NOT NULL
...
INSERT INTO `feedback_table` (`event_name`, `event_id`, `feeback_form_link`) VALUES
('Competitive Coding', 4, 'https://forms.gle/XiUp2DWMXSfLNaNp8'),
('PUBG', 5, 'https://forms.gle/XiUp2DWMXSfLNaNp8'),
('Counter-Strike', 6, 'https://forms.gle/XiUp2DWMXSfLNaNp8'),
('Cooking ', 11, 'https://forms.gle/XiUp2DWMXSfLNaNp8'),
('Technical Quiz', 12, 'https://forms.gle/XiUp2DWMXSfLNaNp8');
...
--
ALTER TABLE `feedback_table`
  ADD CONSTRAINT `foreign_key` FOREIGN KEY (`event_id`) REFERENCES `events` (`event_id`);
COMMIT;
